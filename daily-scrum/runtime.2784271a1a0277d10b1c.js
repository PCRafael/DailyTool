(() => {
  ...
  (r.m = v),
    ...
    (r.O = (n, t, u, o) => {
      if (!t) {
        ...
        for (i = 0; i < e.length; i++) {
          for (var [t, u, o] = e[i], s = !0, f = 0; f < t.length; f++)
            (!1 & o || a >= o) && Object.keys(r.O).every((b) => r.O[b](t[f]))
              ? t.splice(f--, 1)
              : ((s = !1), o < a && (a = o));
          if (s) {
            e.splice(i--, 1);
    ...
    (r.u = (e) => e + ".3e20b91f8a1b09f1aac9.js"),
    (r.miniCssF = (e) => "styles.82a8dd2796926d1fb8a3.css"),
    ...
    (() => {
      ...
      var n = (u, o) => {
          ...
          if (s) var c = s(r);
          for (u && u(o); l < i.length; l++)
            r.o(e, (d = i[l])) && e[d] && e[d][0](), (e[i[l]] = 0);
          return r.O(c);
        },
        t = (self.webpackChunkdaily_scrum = self.webpackChunkdaily_scrum || []);
